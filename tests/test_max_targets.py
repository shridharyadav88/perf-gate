...
big_o_mod = _load_module(
    "_test_mt_big_o", "code-optimizer/scripts/profilers/run_big_o.py"
)
line_mod = _load_module(
    "_test_mt_line", "code-optimizer/scripts/profilers/run_line_profile.py"
)
gen_mod = _load_module("_test_mt_gen", "code-optimizer/scripts/generate_baseline_csv.py")
